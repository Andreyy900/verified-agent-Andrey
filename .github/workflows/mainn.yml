...
on:
  workflow_dispatch:
    inputs:
      agent_name:
        description: 'Andreyrahmat'
        required: true
        default: 'Andreyrahmat'
      agent_description:
        description: 'Andreyrahmat'
        required: true
        default: 'Andreyrahmat AI Agent'
  ...
  verify:
    ...
    steps:
      ...
      - name: Step 3 - Link Human to Agent
        run: |
          node scripts/manualLinkHumanToAgent.js --challenge '{"name": "Andreyrahmat", "description": "Andreyrahmat AI Agent"}'
